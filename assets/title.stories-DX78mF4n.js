import{j as l}from"./jsx-runtime-DEdD30eg.js";import{T as r}from"./title-CD8xfGAz.js";import"./index-RYns6xqu.js";const x={title:"Component/Title",component:r,tags:["autodocs"],argTypes:{themeColor:{description:"主題顏色",control:{type:"select",options:["neutral","primary","secondary","info","success","warning","error"]},table:{category:"PROPS"}},level:{description:"標題等級",control:{type:"select",options:[0,1,2,3,4,5,6]},table:{category:"PROPS"}},className:{description:"客製化樣式",table:{category:"PROPS"}},children:{description:"標題內容",table:{category:"SLOTS"}}},parameters:{docs:{title:"Title",description:{component:"標題組件的呈現及說明。"}}},args:{themeColor:"neutral",level:1,className:"",children:"Title"}},i={name:"預設項目",args:{},render(e){return l.jsx(r,{...e,children:e.children})}},t={name:"標題大小",args:{},parameters:{docs:{source:{code:`
...
`}}},render(e){return l.jsxs("div",{style:{display:"flex",gap:"8px"},children:[l.jsx(r,{level:e.level,themeColor:"neutral",children:e.children}),l.jsx(r,{level:e.level,themeColor:"primary",children:e.children}),l.jsx(r,{level:e.level,themeColor:"secondary",children:e.children}),l.jsx(r,{level:e.level,themeColor:"info",children:e.children}),l.jsx(r,{level:e.level,themeColor:"success",children:e.children}),l.jsx(r,{level:e.level,themeColor:"warning",children:e.children}),l.jsx(r,{level:e.level,themeColor:"error",children:e.children})]})}};var s,o,c;i.parameters={...i.parameters,docs:{...(s=i.parameters)==null?void 0:s.docs,source:{originalSource:`{
  name: '預設項目',
  args: {},
  render(args) {
...
}`,...(m=(T=n.parameters)==null?void 0:T.docs)==null?void 0:m.source}}};const C=["Default","Size","Theme"];export{i as Default,t as Size,n as Theme,C as __namedExportsOrder,x as default};
