import{j as e}from"./jsx-runtime-DEdD30eg.js";import{R as b,r as _}from"./index-RYns6xqu.js";import{g as q}from"./string-bv4IUxbB.js";import"./warning-DPjiZ-Sx.js";import{S as o}from"./notification-NM2mg_B2.js";const c=({themeColor:t="error",children:n,isShowDot:l=!1,value:r=0,limit:i=0,className:j=""})=>{const[D,m]=b.useState(r||0);return _.useEffect(()=>{if(r&&i&&r>i){m(i);return}return m(r||0)},[r,i]),e.jsxs("div",{className:`ded-badge-container ${j}`,children:[n,e.jsx("div",{className:`ded-badge 
          ${q("ded-badge-color",t)}
