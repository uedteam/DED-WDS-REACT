import{j as e}from"./jsx-runtime-DEdD30eg.js";import"./pagination-BcWBc1p5.js";import"./badge-vsbKzH_B.js";import"./breadcrumb-BeC0CIbY.js";import{T as B,B as l}from"./toast-DIhnouBr.js";import"./checkbox-BBF5yrDs.js";import"./progress-circle-wFm81-mr.js";import"./progress-line-DG1O7uhi.js";import"./divider-ChKDBDeF.js";import"./image-CZs88QCg.js";import"./input-DoUPnDdK.js";import"./radio-CMOPLxLt.js";import"./textarea-CO8Z8fZG.js";import{T as m}from"./title-JGunjryD.js";import"./toggle-Ck5Sa1oo.js";import"./menu-Burl5-s8.js";import"./status-indicator-BDww4a8h.js";import"./layout-DbUmifqy.js";import"./tag-zODciKoh.js";import{g as c}from"./string-BqrfsRv8.js";import{j as x,k as g,l as P,m as N,f as h,o as R}from"./disable-circle-np6-bHDN.js";import{r as C}from"./index-RYns6xqu.js";import{R as D}from"./index-sbqOYYIm.js";import"./logout-Cs4pFqLv.js";import"./notification-NM2mg_B2.js";import"./check-BnJBHFpS.js";const O=()=>{const[i,t]=C.useState([]);C.useEffect(()=>{if(i.length===0)return;const n=[...i].sort((A,E)=>A.createdAt-E.createdAt)[0],r=setTimeout(()=>{n.duration!==0&&o(n.id)},n.duration);return()=>clearTimeout(r)},[i]);const a=C.useCallback(s=>{const n=Date.now();return t(r=>[...r,{...s,id:n,createdAt:n,themeColor:s.themeColor||"primary",prefix:s.prefix||null,title:s.title,content:s.content,duration:s.duration}]),n},[]),o=C.useCallback(s=>{t(n=>n.filter(r=>r.id!==s))},[]),d=C.useCallback(()=>i.length===0?null:D.createPortal(e.jsx("div",{className:"ded-toast-container",children:i.map(s=>e.jsx(B,{...s,onClose:()=>o(s.id)},s.id))}),document.body),[i,o]);return{addToast:a,ToastContainer:d}},re={title:"Component/Toast",component:B,tags:["autodocs"],argTypes:{themeColor:{description:"主題顏色",control:{type:"select",options:["primary","secondary","neutral","info","success","warning","error"]},table:{category:"PROPS"}},title:{description:"標題",table:{category:"PROPS"}},content:{description:"內容",table:{category:"PROPS"}},prefix:{description:"前綴",options:["SvgInfoCircle","SvgSuccessCircle","SvgWarningTri","SvgErrorCircle"],mapping:{SvgInfoCircle:e.jsx(x,{}),SvgSuccessCircle:e.jsx(g,{}),SvgWarningTri:e.jsx(P,{}),SvgErrorCircle:e.jsx(N,{})},table:{category:"PROPS"}},duration:{description:"持續時間",control:{type:"range",step:100,min:0,max:5e3},table:{category:"PROPS"}},className:{description:"客製化樣式",table:{category:"PROPS"}},onClose:{description:"關閉事件",table:{category:"EVENTS"}}},args:{themeColor:"success",onClose:()=>window.alert("close"),title:"Notification Title ",content:"Content",action:e.jsx("div",{onClick:()=>window.alert("action"),children:"Action"}),prefix:e.jsx(g,{width:18,height:18}),duration:500,className:""},parameters:{docs:{title:"Toast",description:{component:"通知訊息組件的呈現及說明。"},source:{transform(i,t){const{args:a}=t;return`
...
`}}}}},v={name:"預設項目",args:{action:e.jsx("div",{onClick:()=>window.alert("action"),children:"Action"})},render(i){const{themeColor:t,title:a,content:o,action:d,prefix:s,onClose:n=()=>({}),className:r}=i;return e.jsxs("div",{className:`ded-toast 
        ...
        ${n}`,children:[e.jsx(l,{variant:"text",onClick:s,themeColor:"neutral",className:"ded-close-button",children:e.jsx(h,{width:18,height:18,onClick:s})}),e.jsxs("div",{className:"ded-toast-header",children:[e.jsxs("div",{className:"ded-toast-header-message ded-toast-header-message-success",children:[e.jsx(g,{width:18,height:18}),e.jsx(m,{level:5,themeColor:"success",children:t})]}),o&&e.jsx("div",{className:"ded-toast-header-action",children:o})]}),e.jsx("p",{className:"ded-description",children:a})]}),e.jsxs("div",{className:`ded-toast 
            ...
            ${n}`,children:[e.jsx(l,{variant:"text",onClick:s,themeColor:"neutral",className:"ded-close-button",children:e.jsx(h,{width:18,height:18,onClick:s})}),e.jsxs("div",{className:"ded-toast-header",children:[e.jsxs("div",{className:"ded-toast-header-message ded-toast-header-message-neutral",children:[e.jsx(R,{width:18,height:18}),e.jsx(m,{level:5,themeColor:"info",children:t})]}),o&&e.jsx("div",{className:"ded-toast-header-action",children:o})]}),e.jsx("p",{className:"ded-description",children:a})]})]})}},u={name:"互動模式",args:{themeColor:"success",onClose:()=>window.alert("close"),title:"Notification title ",content:"Content",action:e.jsx("div",{onClick:()=>window.alert("action"),children:"Action"}),prefix:e.jsx(x,{width:18,height:18}),duration:1e3,className:""},render:function(t){const{addToast:a,ToastContainer:o}=O(),d=()=>{a({themeColor:(t==null?void 0:t.themeColor)||"success",title:(t==null?void 0:t.title)||"Title",content:(t==null?void 0:t.content)||"Content",action:(t==null?void 0:t.action)||e.jsx("div",{children:"Action"}),prefix:(t==null?void 0:t.prefix)||e.jsx(N,{width:18,height:18}),duration:t==null?void 0:t.duration})};return e.jsxs(e.Fragment,{children:[e.jsx(l,{onClick:d,variant:"filled",children:"Open Dialog"}),e.jsx(o,{})]})}};var j,w,f;v.parameters={...v.parameters,docs:{...(j=v.parameters)==null?void 0:j.docs,source:{originalSource:`{
  name: '預設項目',
  args: {
...
}`,...(y=($=u.parameters)==null?void 0:$.docs)==null?void 0:y.source}}};const le=["Default","Type","Demo"];export{v as Default,u as Demo,p as Type,le as __namedExportsOrder,re as default};
