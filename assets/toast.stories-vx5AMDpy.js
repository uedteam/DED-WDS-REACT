import{j as e}from"./jsx-runtime-DEdD30eg.js";import{T as m}from"./title-C0o4P0Zd.js";import{T as S,B as c}from"./toast-C2I02jxk.js";import"./checkbox-Dx9j1Oee.js";import"./input-CsvIf6m6.js";import"./textarea-CO8Z8fZG.js";import"./toggle-Ck5Sa1oo.js";import"./radio-CMOPLxLt.js";import"./side-nav-DDXP93i9.js";import"./breadcrumb-DrXwihe_.js";import"./progress-circle-wFm81-mr.js";import"./progress-line-DG1O7uhi.js";import"./menu-DYIHftZB.js";import"./image-CZs88QCg.js";import"./status-indicator-BDww4a8h.js";import"./badge-vsbKzH_B.js";import"./layout-DbUmifqy.js";import{g as l}from"./string-BqrfsRv8.js";import{c as N,d as x,W as B,E as g,C as h,D as E}from"./disable-circle-Qt9C8lli.js";import{r as C}from"./index-RYns6xqu.js";import{R as D}from"./index-sbqOYYIm.js";import"./check-BnJBHFpS.js";import"./logout-Cs4pFqLv.js";import"./notification-NM2mg_B2.js";const R=()=>{const[i,t]=C.useState([]);C.useEffect(()=>{if(i.length===0)return;const s=[...i].sort((P,A)=>P.createdAt-A.createdAt)[0],r=setTimeout(()=>{s.duration!==0&&o(s.id)},s.duration);return()=>clearTimeout(r)},[i]);const a=C.useCallback(n=>{const s=Date.now();return t(r=>[...r,{...n,id:s,createdAt:s,themeColor:n.themeColor||"primary",prefix:n.prefix||null,title:n.title,content:n.content,duration:n.duration}]),s},[]),o=C.useCallback(n=>{t(s=>s.filter(r=>r.id!==n))},[]),d=C.useCallback(()=>i.length===0?null:D.createPortal(e.jsx("div",{className:"ded-toast-container",children:i.map(n=>e.jsx(S,{...n,onClose:()=>o(n.id)},n.id))}),document.body),[i,o]);return{addToast:a,ToastContainer:d}},ie={title:"Component/Toast",component:S,tags:["autodocs"],argTypes:{themeColor:{description:"主題顏色",control:{type:"select",options:["primary","secondary","neutral","info","success","warning","error"]},table:{category:"PROPS"}},title:{description:"標題",table:{category:"PROPS"}},content:{description:"內容",table:{category:"PROPS"}},prefix:{description:"前綴",options:["InfoCircleIcon","SuccessCircleIcon","WarningTriIcon","ErrorCircleIcon"],mapping:{InfoCircleIcon:e.jsx(N,{}),SuccessCircleIcon:e.jsx(x,{}),WarningTriIcon:e.jsx(B,{}),ErrorCircleIcon:e.jsx(g,{})},table:{category:"PROPS"}},duration:{description:"持續時間",control:{type:"range",step:100,min:0,max:5e3},table:{category:"PROPS"}},className:{description:"客製化樣式",table:{category:"PROPS"}},onClose:{description:"關閉事件",table:{category:"EVENTS"}}},args:{themeColor:"success",onClose:()=>window.alert("close"),title:"Notification Title ",content:"Content",action:e.jsx("div",{onClick:()=>window.alert("action"),children:"Action"}),prefix:e.jsx(x,{width:18,height:18}),duration:500,className:""},parameters:{docs:{title:"Toast",description:{component:"通知訊息組件的呈現及說明。"},source:{transform(i,t){const{args:a}=t;return`
...
}`,...(y=($=v.parameters)==null?void 0:$.docs)==null?void 0:y.source}}};const de=["Default","Type","Demo"];export{p as Default,v as Demo,u as Type,de as __namedExportsOrder,ie as default};
