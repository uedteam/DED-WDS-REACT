import{j as l}from"./jsx-runtime-CkxqCPlQ.js";import{T as r}from"./title-ExmiU3Le.js";import"./index-DJO9vBfz.js";import"./lodash-BawsgTSI.js";const y={title:"Component/Title",component:r,tags:["autodocs"],argTypes:{themeColor:{description:"主題顏色",control:{type:"select",options:["primary","secondary","tertiary","info","success","warning","error"]},table:{category:"PROPS"}},level:{description:"標題等級",control:{type:"select",options:[0,1,2,3,4,5,6]},table:{category:"PROPS"}},className:{description:"客製化樣式",table:{category:"PROPS"}},children:{description:"標題內容",table:{category:"SLOTS"}}},parameters:{docs:{title:"標題",description:{component:"標題組件的呈現及說明。"}}},args:{themeColor:"primary",level:1,className:"",children:"Title"}},i={name:"預設項目",args:{},render(e){return l.jsx(r,{...e,children:e.children})}},t={name:"標題大小",args:{},parameters:{docs:{source:{code:`
...
}`,...(m=(T=n.parameters)==null?void 0:T.docs)==null?void 0:m.source}}};const C=["Default","Size","Theme"];export{i as Default,t as Size,n as Theme,C as __namedExportsOrder,y as default};
