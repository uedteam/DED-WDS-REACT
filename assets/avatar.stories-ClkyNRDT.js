import{j as e}from"./jsx-runtime-CkxqCPlQ.js";import{A as a}from"./avatar-CUlbHiRI.js";import"./index-DJO9vBfz.js";import"./offline-BimsrpRK.js";const y={title:"Component/Avatar",component:a,tags:["autodocs"],argTypes:{shape:{description:"形狀",control:{type:"select",options:["circle","square"]},table:{category:"PROPS"}},size:{description:"尺寸",control:{type:"select",options:["xsmall","small","medium","large"]},table:{category:"PROPS"}},status:{description:"狀態",control:{type:"select",options:["none","online","idle","busy","offline"]},table:{category:"PROPS"}},src:{description:"圖片連結",table:{category:"PROPS"}},alt:{description:"圖片描述",table:{category:"PROPS"}},userName:{description:"使用者名稱",table:{category:"PROPS"}},className:{description:"客製化樣式",table:{category:"PROPS"}}},parameters:{docs:{title:"Avatar",description:{component:"個人頭像的呈現及說明。"}}},args:{shape:"circle",size:"large",status:"none",src:"https://picsum.photos/200/300",alt:"無圖顯示",userName:"Kevin",className:""}},r={name:"預設項目",args:{},render(s){return e.jsx(a,{...s})}},t={name:"頭像形狀",args:{src:"https://picsum.photos/320/240"},parameters:{docs:{source:{code:`
