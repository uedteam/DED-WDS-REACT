import{j as e}from"./jsx-runtime-DEdD30eg.js";import{A as a}from"./avatar-BTv4bZ6K.js";import"./index-RYns6xqu.js";import"./auo-TMZ-BSoc.js";import"./offline-Bm72BRFT.js";const f={title:"Component/Avatar",component:a,tags:["autodocs"],argTypes:{shape:{description:"形狀",control:{type:"select",options:["circle","square"]},table:{category:"PROPS"}},size:{description:"尺寸",control:{type:"select",options:["xsmall","small","medium","large"]},table:{category:"PROPS"}},status:{description:"狀態",control:{type:"select",options:["none","online","idle","busy","offline"]},table:{category:"PROPS"}},src:{description:"圖片連結",table:{category:"PROPS"}},alt:{description:"圖片描述",table:{category:"PROPS"}},userName:{description:"使用者名稱",table:{category:"PROPS"}},className:{description:"客製化樣式",table:{category:"PROPS"}}},parameters:{docs:{title:"Avatar",description:{component:"個人頭像的呈現及說明。"}}},args:{shape:"circle",size:"large",status:"none",src:"https://picsum.photos/200/300",alt:"無圖顯示",userName:"Kevin",className:""}},r={name:"預設項目",args:{},render(s){return e.jsx(a,{...s})}},t={name:"頭像形狀",args:{src:"https://picsum.photos/320/240"},parameters:{docs:{source:{code:`
...
}`,...(h=(d=c.parameters)==null?void 0:d.docs)==null?void 0:h.source}}};const z=["Default","AvatarShape","AvatarStatus"];export{t as AvatarShape,c as AvatarStatus,r as Default,z as __namedExportsOrder,f as default};
